...
<body>
    ...
    <div class="bg-indigo-900 relative overflow-hidden">
        ...
        <div class="w-full min-h-screen mx-auto px-6 md:px-12 relative z-10 flex items-center py-24 xl:py-40">
            <div class="lg:w-3/5 xl:w-2/5 flex flex-col items-start relative z-10">
                <span class="font-mitr uppercase text-white">School Application</span>
    
                <h1 class="font-roboto-slab text-4xl sm:text-6xl text-red-400 leading-tight mt-4">Let's go <br> back to
                    school</h1>
    
                <div class="max-w-md">
                    <p class="font-source-sans-pro text-white mt-6 text-lg">Lorem ipsum dolor sit amet consectetur
            ...
            <svg class="hidden sm:block absolute bottom-0 right-0 -mr-40 lg:mr-0" xmlns="http://www.w3.org/2000/svg"
                ...
                <g data-name="Capa 1">
                    ...
                    <path fill="#e8c275" d="M425.23 300.62h-13.31c-1.9 9.91 4.21 17.51 6.66 17.51s8.55-7.6 6.65-17.51z" />
                    <path fill="#f3eece"
                    ...
                    <path fill="#675763" d="M414.91 295.41l-.33 3.14a14.1 14.1 0 008.62 0l-.33-3.13a13 13 0 01-7.96-.01z" />
                    <path fill="#e7bd88"
                    ...
                    <path fill="#d28088" d="M418.89 283.11c0 3.68-3.27 6.24-12.68 4.72a42 42 0 0025.36 0V262.3l-12.68 2z" />
                    <path fill="#e1afb9" d="M406.21 249.65H393.5v25.48c0 3.75 2.48 7.5 7.43 10.36a29 29 0 005.28 2.34z" />
                    <path fill="#eacbd2"
                    ...
                    <path fill="#a8c0e3" d="M393.5 239.78v9.87c0 3.74 2.48 7.49 7.43 10.35a29 29 0 005.28 2.32v-22.54z" />
                    <path fill="#d3e8f7" d="M403.18 239.78h-6.65v16.8a18.91 18.91 0 004.4 3.42c.72.41 1.48.79 2.25 1.14z" />
                    ...
                    <path fill="#f1f8fc" d="M403.18 229.92h-6.65v16.8a19.18 19.18 0 004.4 3.42c.72.41 1.48.78 2.25 1.13z" />
                    ...
                    <path fill="#a8c0e3" d="M393.5 220.05v9.87c0 3.74 2.48 7.49 7.43 10.35a29 29 0 005.28 2.32v-22.54z" />
                    <path fill="#d3e8f7" d="M403.18 220.05h-6.65v16.8a18.91 18.91 0 004.4 3.42c.72.41 1.48.79 2.25 1.14z" />
                    ...
                    <path fill="#5f71ae" d="M444.2 220.05c0 3.45-2.09 6.9-6.31 9.67v9.86c4-2.59 6.06-5.79 6.31-9v-10.53z" />
                    <path fill="#f5e5c2"
                    ...
                    <path fill="#7591c5" d="M424.38 220.22v-8.31a5.52 5.52 0 00-5.51-5.52v19.35a5.52 5.52 0 005.51-5.52z" />
                    <text fill="#fcf7ed" font-family="AsapCondensed-SemiBold,Asap Condensed" font-size="15.5"
                        font-weight="600" transform="translate(415.31 221.62)">2</text>
                    <path fill="#5f71ae"
